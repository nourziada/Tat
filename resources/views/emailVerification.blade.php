...
<head>
    ...
    <title>Verification Code From TAT</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td  style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal;">Dear {{$name}}</h1>
                                    <p style="margin: 0;">We have received a request to Verified your account.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                               <td  style="text-align: right;padding-right: 40px; padding-bottom: 10px;  font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                                <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;">To Verify your Account please copy this code : </span>
                                                <span style="margin: 0;">{{$verificationToken}}</span>
                                            </td>
                            </tr>
