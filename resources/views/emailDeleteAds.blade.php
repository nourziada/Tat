...
<head>
    ...
    <title>Remove Your Ads in TAT WebSite</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td  style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    ...
                                    <p style="margin: 0;">We Remove Your Ads from our Website , Becouse Your ad has been deleted to contain inappropriate content</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: right;padding-right: 40px; padding-bottom: 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;">Ads Title : </span>
