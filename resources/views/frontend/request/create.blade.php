...
<section id="main" class="clearfix ad-details-page">
		<div class="container">
			...
			<form name="ad-post" id="ad-post" method="post" action="{{route('request.store')}}" enctype="multipart/form-data" style="display: block !important;">
							...
							<fieldset>
								<div class="section postdetails">
									...
									<div class="row form-group add-title">
										...
										<div class="col-sm-9">
											<input type="text" name="title" class="form-control" id="text" required="required">
										</div>
									</div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="upload-section">
                                                <label class="upload-image" for="upload-image-one">
                                                    <img src="" class="lisitingpreview" alt="">
                                    ...
                                    <div class="row form-group add-title">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" name="desc" class="form-control" id="desc" required="required"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group add-title">
										...
										<div class="col-sm-9">
											<input type="text" name="city" class="form-control" id="text" required="required">
										</div>
									</div>

									<div class="row form-group" style="margin-left: 0;">	
										<button type="submit" name="ad_post_submit" class="btn btn-primary pull-left" >Add your request</button>
									</div>		
								</div><!-- section -->	
