								...
								<div class="section postdetails">
									...
									<div class="row form-group">
										...
										@forelse($categories as $cat)
											<input type="radio" name="category_id" value="{{$cat->id}}" id="{{$cat->id}}"> <label for="{{$cat->id}}">{{$cat->name }}</label>
									...
									<div class="row form-group add-title">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="text" placeholder="ex, Sony Xperia dual sim 100% brand new " name="title" required>
										</div>
									</div>
									...
									<div class="row form-group select-price">
										...
										<div class="col-sm-9">
											<label>$USD</label>
											<input type="text" name="price" class="form-control" id="text1" required>
										</div>
									</div>
									<div class="row form-group item-description">
										<label class="col-sm-3 label-title">Description<span class="required">*</span></label>
										<div class="col-sm-9">
											<textarea class="form-control" id="textarea" placeholder="Write few lines about your products" rows="8" name="desc" onkeyup="textCounter(this,'counter',5000);"></textarea>		
										</div>
									</div>
									<div class="row">
